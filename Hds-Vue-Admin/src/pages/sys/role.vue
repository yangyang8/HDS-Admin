            ...
            <el-form :model="form" ref="form">
              <el-form-item label="父级" :label-width="formLabelWidth">
                ...
                <!-- <el-select-tree v-model="form.parentId" :treeData="roleTree" :propNames="defaultProps" clearable
                  ...
                  <el-select-tree v-model="form.parentId" :treeData="roleTree" clearable
                                placeholder="请选择父级">
                </el-select-tree>
              ...
              <el-form-item label="" :label-width="formLabelWidth">
                <el-button type="primary" @click="onSubmit" v-text="form.roleId?'修改':'新增'"></el-button>
                <el-button type="info" @click="settingResource($event,form.roleId)" icon="setting" v-show="form.roleId && form.roleId!=null">配置资源
                </el-button>
                <el-button type="danger" @click="deleteSelected" icon="delete" v-show="form.roleId && form.roleId!=null">删除
                </el-button>
              </el-form-item>
            </el-form>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteSelected(id){
        this.$http.post(api.SYS_ROLE_DELETE + "?roleId=" + id)
          .then(res => {
            this.$message('操作成功');
