      ...
      <el-col :span="24" :xs="24" :sm="8" :md="8" :lg="8">
        <div class="login-register">
          <div class="card-block">
            <h2>注册</h2>
            <p>平台暂时只支持使用公司邮箱注册.</p>
            <el-button type="info" @click="register" class="btn btn-primary active m-t-1"> 马上注册</el-button>
          </div>
        </div>
        </el-col>
        </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      login(){
              ...
              //   this.loginSuccess({"sid":res.token,"user":res.data,redirectUrl})
              // })
