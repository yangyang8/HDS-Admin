<template>
  <header class="main-header animated" :class="{closeLogo:sidebar.collapsed,mobileLogo:device.isMobile}">
    <a href="#" class="logo">
      <span class="logo-lg"><i class="fa fa-diamond"></i>&nbsp; <b>项目管理平台</b></span>
    </a>
    <nav class="navbar">
      ...
      <div class="navbar-custom-menu">
        ...
        <el-dropdown trigger="click" class="navbar-dropdown">
          <div class="el-dropdown-link">
            <img :src='userInfo.userpic' style="width: 25px;height: 25px;border-radius: 50%; vertical-align: middle;" alt="U">
            {{userInfo.username}}
          </div>
          <el-dropdown-menu style="padding: 0px">
            <div>
              <div class="header-pic">
                <img :src='userInfo.userpic' class="img-circle" alt="User Image" >
...
<script>
  ...
  export default {
    ...
    created(){
	  ...
	  let item=utilApi.getUserSession("activeUser");
      if (!!item){
